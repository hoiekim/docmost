...
import { BaseView } from "@/ce/base/components/base-view";
import { BaseTableSkeleton } from "@/ce/base/components/base-table-skeleton";
import { useBaseQuery } from "@/ce/base/queries/base-query";
